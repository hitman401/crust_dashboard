  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <Skeleton loading={loading} paragraph={{ rows: 13 }} active animate>
            <Charts dataSource={chartData} maxRange={data.max} />
          </Skeleton>
        </Card>
      </div>
    )
    ...
    return (
      <div>
        <Card
          ...
          title="Connections"
        >
          <Skeleton loading={loading || data.loading} paragraph={{ rows: 13 }} active animate>
